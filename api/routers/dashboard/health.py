...
# ----------------------------------------- GET /health/scanners --
@router.get("/scanners")
async def get_scanner_health(current_user: dict = Depends(require_tenant_match), db: AsyncSession = Depends(get_tenant_db)):
...
# ------------------------------------------ GET /health/beacons --
@router.get("/beacons")
async def get_beacon_health(current_user: dict = Depends(require_tenant_match), db: AsyncSession = Depends(get_tenant_db)):
...
@router.get("/summary")
async def get_health_summary(current_user: dict = Depends(require_tenant_match), db: AsyncSession = Depends(get_tenant_db)):
