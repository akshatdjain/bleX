...
@router.get("")
async def get_scanners(db: AsyncSession = Depends(get_tenant_db)):
    ...
    return [
        {
            ...
            "status": r.scanner_status or _scanner_status(r.last_heartbeat),
            "is_online": (r.scanner_status or _scanner_status(r.last_heartbeat)) != "offline",
        }
        for r in rows
    ]
