            ...
            notifications.map((n) => {
              ...
              return (
                <div
                  key={n.id}
                  className={cn(
                    "flex gap-3 px-4 py-3 border-b last:border-0 transition-colors cursor-pointer hover:bg-muted/40",
                    !n.read && "bg-accent/30"
                  )}
                  onClick={() => {
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <span className="text-[11px] text-muted-foreground/70 mt-1 block font-mono">
                      {timeAgo(n.timestamp)}
                    </span>
                  </div>
                </div>
