...
# - waits for network
# - registers master (posts Pi IP to DGX so Android can auto-discover it)
# - runs master + fifo in parallel
# =================================================

BASE_DIR="/home/blex/Desktop/blex/master"
...
#    Posts Pi IP + tenant_id to DGX so Android app
#    can auto-discover this Pi after login
# -------------------------------------------------
