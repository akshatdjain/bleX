...
class TelemetryLogger:
    def __init__(self, base_dir="logs", prefix="telemetry_master", flush_interval_sec=1.0, max_queue_size=10000, use_utc=True):
    ...
    def _open_file_if_needed(self):
        ...
        if date_str != self._current_date:
            ...
            self._seq = 0
            path = os.path.join(self.base_dir, f"{self.prefix}_{date_str}.jsonl")
