...
object AppConfig {
    ...
    /** Hostname of the DGX cloud server */
    const val REMOTE_MQTT_HOST = "sigmatic-asc.tech"

    /** Port for Pi direct TLS MQTT (mqtts://) */
    const val REMOTE_MQTT_PORT_TLS = 8883

    /** Port for Android bridge WSS (Caddy terminates TLS on 443) */
    const val REMOTE_MQTT_PORT_WSS = 443

    /** WebSocket path required by Caddy reverse proxy */
    const val REMOTE_MQTT_WSS_PATH = "/mqtt"

    /** Base URL for the asset REST API */
