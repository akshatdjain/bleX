    ...
    <div className="landing-scroll" style={{ fontFamily: T.fontHead, background: T.white, color: T.tealDark }}>
      ...
      <section style={{ padding: "clamp(24px, 3vh, 48px) clamp(20px, 5vw, 72px)", background: T.white, minHeight: "calc(100vh - 68px)", display: "flex", flexDirection: "column" as const, justifyContent: "center" }}>
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontFamily: T.fontBody, fontSize: "13px", fontWeight: 500, color: T.tealMid }}>
              Real-time BLE tracking, works offline
            </span>
          </div>
          ...
          <h1 style={{
            ...
            <span style={{ fontWeight: 400, opacity: 0.7 }}>Right now.</span>
          </h1>
          ...
          <p style={{
            ...
            Attach a beacon. Place a node. Your tablet becomes a live tracking hub in minutes.
            Zone logic runs on-device, no cloud needed, no IT department, no setup call.
          </p>
        ...
        <div className="stats-row" style={{
          ...
          {[
            { ref: c1,  suffix: "s",  label: "Zone detection" },
            { ref: c2,  suffix: "+",  label: "Nodes per hub" },
            { ref: c3,  suffix: "%",  label: "Works offline" },
          ].map((s, i) => (
            <div key={i} style={{
      ...
      <section className="snap-section" style={{ padding: "72px clamp(20px, 5vw, 72px)", background: T.white, minHeight: "100vh", display: "flex", flexDirection: "column" as const, justifyContent: "center", borderTop: "1px solid rgba(0,95,103,0.08)" }}>
        <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
          ...
          }}>Three things to know. Nothing else.</h2>
          ...
          <div className="grid-3" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "20px", alignItems: "stretch" }}>
            ...
            <div className="hover-lift" style={{ padding: "28px 24px", border: `1px solid ${T.cardBorder}`, borderRadius: "16px", background: T.sectionBg, display: "flex", flexDirection: "column" as const }}>
              ...
              <h4 style={{ fontFamily: T.fontHead, fontSize: "19px", fontWeight: 700, color: T.tealDark, marginBottom: "12px", letterSpacing: "-0.3px" }}>A BleX Node</h4>
              <p style={{ fontFamily: T.fontBody, fontSize: "14px", color: T.bodyText, lineHeight: 1.75, marginBottom: "20px", flex: 1 }}>
                A device that listens for BLE beacons in its vicinity. When a beacon comes in range, the node picks it up, measures signal strength, and reports it continuously to the hub.
              </p>
              <div style={{ display: "flex", flexDirection: "column" as const, gap: "8px" }}>
                {[
                  { label: "Raspberry Pi", sub: "Edge device, mounts at zone boundaries" },
                  { label: "Android Tablet", sub: "All-in-one hub: node, broker, dashboard" },
                ].map((item) => (
            ...
            <div className="hover-lift" style={{ padding: "28px 24px", border: `1px solid ${T.cardBorder}`, borderRadius: "16px", background: T.sectionBg, display: "flex", flexDirection: "column" as const }}>
              ...
              <p style={{ fontFamily: T.fontBody, fontSize: "14px", color: T.bodyText, lineHeight: 1.75, marginBottom: "20px", flex: 1 }}>
                A zone is a named location you define: a room, a floor, a warehouse aisle. Add a BleX node to it and it joins your tracking network. Assets that enter are automatically logged.
              </p>
      ...
      <section id="how" className="snap-section" style={{
        ...
        <div style={{ maxWidth: "1400px", margin: "0 auto", width: "100%" }}>
          <div style={{ display: "flex", gap: "48px", alignItems: "flex-start" }} className="split">
            ...
            <div style={{ flex: "0 0 280px", display: "flex", flexDirection: "column" as const, alignSelf: "stretch" }}>
              ...
              <div style={{ position: "relative", paddingLeft: "20px", flex: 1, display: "flex", flexDirection: "column" as const, justifyContent: "space-between" }}>
                <div style={{
                  ...
                  width: "2px", borderLeft: "2px dashed rgba(0,95,103,0.2)",
                }} />
                ...
                {[
                  ...
                  { num: "02", title: "Place nodes", time: "5 min", color: T.tealMid,
                  ...
                  <div key={s.num} style={{ display: "flex", gap: "12px", position: "relative" }}>
                    <div style={{
                      width: "20px", height: "20px", borderRadius: "50%",
                      background: s.color, color: T.white,
                      display: "flex", alignItems: "center", justifyContent: "center",
                      fontFamily: T.fontMono, fontSize: "9px", fontWeight: 700,
                      flexShrink: 0, position: "absolute", left: "-30px", top: "1px",
                    }}>
                      {s.num}
                    </div>
                    <div style={{ flex: 1, paddingTop: "2px" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "4px", flexWrap: "wrap" }}>
                        <h5 style={{ fontFamily: T.fontHead, fontSize: "15px", fontWeight: 700, color: T.tealDark }}>{s.title}</h5>
                        <span style={{
                          fontFamily: T.fontMono, fontSize: "11px", fontWeight: 600,
                          color: s.color, background: `${s.color}14`,
                          padding: "2px 7px", borderRadius: "4px", border: `1px solid ${s.color}28`,
                        }}>{s.time}</span>
                      </div>
                      <p style={{ fontFamily: T.fontBody, fontSize: "13px", color: T.bodyText, lineHeight: 1.65 }}>{s.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div style={{
              flex: 1, minWidth: 0,
              border: "1px solid rgba(0,95,103,0.15)", borderRadius: "16px",
              boxShadow: "0 0 40px rgba(0,95,103,0.06)", padding: "20px", background: T.white,
            }}>
              <HospitalDemo />
            </div>
          ...
          <div style={{ display: "flex", gap: "56px", alignItems: "flex-end", marginBottom: "48px" }} className="split">
            <div style={{ flex: "0 0 400px" }}>
              ...
              <h2 style={{
                ...
                fontWeight: 800, color: T.tealLight, letterSpacing: "-1px", lineHeight: 1.1,
            ...
            <p style={{ fontFamily: T.fontBody, fontSize: "16px", color: "rgba(213,245,244,0.65)", lineHeight: 1.8, flex: 1 }}>
              Enterprise tracking used to mean weeks of setup, vendor contracts, and a dedicated IT project. BleX runs on hardware you already have. Setup takes a morning.
            </p>
          </div>
            ...
            {[
              {
                ...
                body: "Nodes broadcast their presence over UDP. The tablet finds them. You tap once to provision. No static IPs, no DHCP reservations, no firewall rules to touch.",
              },
              {
              ...
              },
              {
                ...
                body: "The tablet runs a full MQTT broker locally. Zone logic processes at the edge. A dead WAN connection does not stop a single zone update from firing.",
              },
              {
                icon: "M22 12h-4l-3 9L9 3l-3 9H2",
                title: "From one room to fifty zones",
                body: "Add nodes, zones, and assets from the app. No infrastructure changes needed. One tablet hub handles 50+ simultaneous nodes. Switch to cloud mode for unlimited scale.",
              },
            ].map(card => (
      ...
      <section className="snap-section" style={{ display: "flex", flexDirection: "column" as const, justifyContent: "flex-start" }}>
        <section style={{ padding: "140px clamp(20px, 5vw, 72px) 72px", background: T.sectionBg }}>
          <div style={{ maxWidth: "700px", margin: "0 auto", textAlign: "center" }}>
            <div style={{
              ...
              letterSpacing: "5px", marginBottom: "28px", border: `1px solid ${T.cardBorder}`,
            }}>HQTJAC</div>
            <h2 style={{
            ...
            }}>One ID. Every node, zone, and asset connected.</h2>
            <p style={{ fontFamily: T.fontBody, fontSize: "16px", color: T.bodyText, lineHeight: 1.8, marginBottom: "40px" }}>
              Register once and you get a six-character workspace ID. Every node, tablet, and beacon links to it automatically. Add hardware and it appears. No re-configuration, no IT ticket.
            </p>
        ...
        <section style={{ background: T.tealDark, padding: "72px clamp(20px, 5vw, 72px)", textAlign: "center", position: "relative", overflow: "hidden", flex: 1 }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            }}>Track your first asset in 10 minutes.</h1>
            <p style={{ fontFamily: T.fontBody, fontSize: "16px", color: "rgba(213,245,244,0.7)", marginBottom: "40px", lineHeight: 1.7 }}>
              No staging environment. No sales call. No IT ticket. Just sign up and go.
            </p>
            <Link to="/register" className="btn-primary" style={{
              display: "inline-flex", alignItems: "center", gap: "8px",
              padding: "14px 34px", borderRadius: "9px", fontSize: "15px",
              fontWeight: 700, color: T.tealDark, fontFamily: T.fontBody, background: T.white,
            }}>
              Create your account
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            </Link>
        ...
        <footer style={{
          ...
          <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
            ...
            <span style={{ fontFamily: T.fontMono, fontSize: "11px", color: "rgba(0,95,103,0.35)" }}>v3.2.0</span>
          </div>
        </footer>
      </section>
    </div>
