...
export function ScannerSheet({ scanner, open, onOpenChange }: ScannerSheetProps) {
  ...
  const rows = [
    ...
    { label: "Last Heartbeat", value: scanner.last_heartbeat ? `${formatTs(scanner.last_heartbeat)} (${timeAgo(scanner.last_heartbeat)})` : "Never" },
  ];
        ...
        <div className="flex flex-col h-full">
          <SheetHeader className="pb-6">
            ...
            <div className="flex items-center gap-1.5 mt-1">
              <StatusDot status={scanner.status as any} />
